...
/mob/living/simple_animal/hostile/retaliate/clown/honkling
	...
	attack_reagent = /datum/reagent/thc
...
/mob/living/simple_animal/hostile/retaliate/clown/fleshclown
	...
	response_disarm = "squishes the spongy flesh of"
...
/mob/living/simple_animal/hostile/retaliate/clown/clownhulk/chlown
	...
	speak = list("HONK", "Honk!", "Bruh", "Heeeeaaaaaaonk")
...
/mob/living/simple_animal/hostile/retaliate/clown/clownhulk/honcmunculus
	...
	attack_reagent = /datum/reagent/krokodil
...
/mob/living/simple_animal/hostile/retaliate/clown/clownhulk/destroyer
	...
	speak = list("HONK!!!", "The Honkmother is merciful, so I must act out her wrath.", "parce mihi ad beatus honkmother placet mihi ut peccata committere,", "DIE!!!", "The Honkmother demands your death!")
	maxHealth = 400
	health = 400
	speed = 5
...
/mob/living/simple_animal/hostile/retaliate/clown/mutant
	...
	loot = list(/obj/item/clothing/mask/gas/clown_hat, /obj/item/soap, /obj/effect/gibspawner/generic, /obj/effect/gibspawner/human)
...
/mob/living/simple_animal/hostile/retaliate/clown/mutant/blob
	...
	loot = list(/obj/item/clothing/mask/gas/clown_hat, /obj/effect/particle_effect/foam, /obj/item/soap, /obj/effect/gibspawner/generic, /obj/effect/gibspawner/human)
	attack_reagent = /datum/reagent/bath_salts