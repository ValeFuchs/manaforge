...
/obj/item/clothing/under/plasmaman/archaeologist
	name = "archaeologist's plasma envirosuit"
	desc = "Made out of a modified voidsuit, this suit was Nanotrasen's first solution to the *logistical problems* that come with employing plasmamen. Due to the modifications, the suit is no longer space-worthy. Despite their limitations, these suits are still used by historian and old-styled plasmamen alike."
