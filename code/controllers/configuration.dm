/datum/configuration
	...
	var/vote_autotransfer_initial = 150000 // Length of time before the first autotransfer vote is called
	var/vote_autotransfer_interval = 72000 // length of time before next sequential autotransfer vote
